...
def button(number):
    ...
    if number == 1:
        # SW01 on
         pygame.quit()
         subprocess.call("/usr/bin/sudo -u pi /home/pi/pitftmenu/zwave/sw1on.sh", shell=True)
         os.execv(__file__, sys.argv)
    if number == 2:
        # SW01 off
         pygame.quit()
         subprocess.call("/usr/bin/sudo -u pi /home/pi/pitftmenu/zwave/sw1off.sh", shell=True)
         os.execv(__file__, sys.argv)
    if number == 3:
        # SW02 on
         pygame.quit()
         subprocess.call("/usr/bin/sudo -u pi /home/pi/pitftmenu/zwave/sw2on.sh", shell=True)
         os.execv(__file__, sys.argv)
    if number == 4:
        # SW02 off
         pygame.quit()
         subprocess.call("/usr/bin/sudo -u pi /home/pi/pitftmenu/zwave/sw2off.sh", shell=True)
         os.execv(__file__, sys.argv)
    if number == 5:
        # Pag. principal
        pygame.quit()
...
make_button("    SW01 on", 30, 105, 55, 210, tron_light)
make_button("    SW02 off", 260, 105, 55, 210, tron_light)
# Third Row buttons 5 and 6
make_button("    SW02 on", 30, 180, 55, 210, tron_light)
make_button("    SW02 off", 260, 180, 55, 210, tron_light)
# Fourth Row Buttons
make_button("   Principal", 30, 255, 55, 210, tron_light)
